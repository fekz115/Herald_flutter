...
<head data-special-styles="/media/css/special.min.css">
    ...
    <script type="text/javascript">
        ...
        serverDate = new Date(Date.parse('2020-07-25T23:57:37+03:00')); //ISO 8601 Extended YYYY-MM-DDTHH:mm:ss.sssZ
...
<div class="g-wrap" id="db">
 ...
 <br>
    ...
    <input id="one-way-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="прибор">
                            ...
                            <div class="rasp-form__row">
                                <div class="rasp-form__place-wrap">
                                    <div class="rasp-form__place storage-wrap">
                                        <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="roundtrip-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="прибор">
                                ...
                                <div class="rasp-form__row-wrap">
                                            ...
                                            <div class="rasp-form__place-wrap">
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="complex1-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="прибор">
    ...
    <input class="main-date hidden" type="hidden" name="date3" value="today">
						...
						<div class="b-note__text">
															<div class="error_content">Нет прямого сообщения между станциями</div>
							&nbsp;
															<a href="/ru/routemulti/?path=ru%2Froute%2F&from=%D0%BF%D1%80%D0%B8%D0%B1%D0%BE%D1%80&from_exp=&from_esr=&to=%D0%9C%D0%B8%D0%BD%D1%81%D0%BA&to_exp=&to_esr=&front_date=%D1%81%D0%B5%D0%B3%D0%BE%D0%B4%D0%BD%D1%8F&date=today">Просмотреть маршруты с пересадками</a>
													</div>
					</div>
