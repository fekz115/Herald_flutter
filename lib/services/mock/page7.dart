...
<head data-special-styles="/media/css/special.min.css">
    ...
    <script type="text/javascript">
        ...
        serverDate = new Date(Date.parse('2020-07-26T00:30:14+03:00')); //ISO 8601 Extended YYYY-MM-DDTHH:mm:ss.sssZ
...
<div class="g-wrap" id="db">
 ...
 <br>
    ...
    <input id="one-way-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="">
    ...
    <div class="rasp-form__tags">
        <a class="rasp-form__tag" href="#" data-from="Минск-Пассажирский" data-exp="2100001"><span>Минск-Пассажирский</span></a>
                                    ...
                                    <div class="rasp-form__place storage-wrap">
                                        <div class="rasp-form__inp rasp-form__inp--place">
    <input id="one-way-raspFormToTitle" class="storage form-control formstyler valid-group-direction js-input-taber" type="text" data-storage="to" name="to" spellcheck="true" placeholder="Куда" autocomplete="off" value="Прибор">
                            ...
                            <div class="rasp-form__row">
                                <div class="rasp-form__place-wrap">
                                    <div class="rasp-form__place storage-wrap">
                                        <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="roundtrip-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="">
    ...
    <div class="rasp-form__tags">
        <a class="rasp-form__tag" href="#" data-from="Минск-Пассажирский" data-exp="2100001"><span>Минск-Пассажирский</span></a>
                                    ...
                                    <div class="rasp-form__place storage-wrap">
                                        <div class="rasp-form__inp rasp-form__inp--place">
    <input id="roundtrip-raspFormToTitle" class="storage form-control formstyler valid-group-direction js-input-taber" type="text" data-storage="to" name="to" spellcheck="true" placeholder="Куда" autocomplete="off" value="Прибор">
                                ...
                                <div class="rasp-form__row-wrap">
                                            ...
                                            <div class="rasp-form__place-wrap">
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="complex1-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="">
    ...
    <a class="rasp-form__ico js-stations-map-open" href="javascript:void(0);" data-exp-id="complex1-raspFormFromExp" data-title-id="complex1-raspFormFromTitle" title="Карта"></a>
                                                ...
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <input id="complex1-raspFormToTitle" class="storage form-control formstyler valid-group-direction js-input-taber" type="text" data-storage="to" name="to" spellcheck="true" placeholder="Куда" autocomplete="off" value="Прибор">
	...
	<div class="b-edit__list">
			...
			<div class="b-edit__col js-to">
				...
				<div class="edit_list">
                    ст. Прибор, Гомельская обл., Беларусь
                    				</div>
			</div>
        	</div>
</div><!-- // b-edit -->
