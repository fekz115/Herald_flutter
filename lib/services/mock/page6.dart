...
<head data-special-styles="/media/css/special.min.css">
    ...
    <meta property="og:url" content="https://pass.rw.by/ru/station"/>
    ...
    <script type="text/javascript">
        ...
        curent_page_url = 'ru/station';
        serverDate = new Date(Date.parse('2020-07-26T00:17:24+03:00')); //ISO 8601 Extended YYYY-MM-DDTHH:mm:ss.sssZ
...
<div class="g-wrap" id="db">
 ...
 <br>
    ...
    <input id="one-way-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="asdfasd">
                            ...
                            <div class="rasp-form__row">
                                <div class="rasp-form__place-wrap">
                                    <div class="rasp-form__place storage-wrap">
                                        <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="roundtrip-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="asdfasd">
                                ...
                                <div class="rasp-form__row-wrap">
                                            ...
                                            <div class="rasp-form__place-wrap">
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="complex1-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from" spellcheck="true" placeholder="Откуда" autocomplete="off" value="asdfasd">
    ...
    <input class="main-date hidden" type="hidden" name="date" value="today">
                                            ...
                                            <div class="rasp-form__place-wrap">
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="complex2-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from2" spellcheck="true" placeholder="Откуда" autocomplete="off" value="asdfasd">
    ...
    <input class="main-date hidden" type="hidden" name="date2" value="today">
                                            ...
                                            <div class="rasp-form__place-wrap">
                                                <div class="rasp-form__place storage-wrap">
                                                    <div class="rasp-form__inp rasp-form__inp--place">
    <div class="rasp-form__history-backdrop"></div>
    <input id="complex3-raspFormFromTitle" class="storage form-control formstyler js-has-history valid-group-direction js-input-taber" type="text" data-storage="from" name="from3" spellcheck="true" placeholder="Откуда" autocomplete="off" value="asdfasd">
    ...
    <input class="main-date hidden" type="hidden" name="date3" value="today">
                            ...
                            <input type="hidden" name="complex" value="1" />
                                    ...
                                    <div class="b-edit">
																								...
																								<div class="b-note">
						<i class="note_pic"></i>
						<div class="b-note__text">
															<div class="error_title">Станция не найдена</div> <div class="error_content">Проверьте, нет ли в запросе опечаток. Или выберите станцию из выпадающего списка.</div>
							&nbsp;
													</div>
					</div>
...
<script>
 ...
 <span class="num">1.</span>Просмотрите список часто задаваемых вопросо<span>в<i class="help-start__icon svg-help-pointer_01"></i></span>
				 ...
				 <ul class="list-reset"><li><a href="/ru/help/travel-documents-tickets/return-tickets/return_abroad.html">Возврат неиспользованных проездных документов (билетов) в дальнее зарубежье</a></li><li><a href="/ru/help/travel-documents-tickets/travel-documents/za_kakoe_vremja_mozhno_priobr1.html">За какое время можно приобрести проездные документы (билеты)?</a></li><li><a href="/ru/help/travel-documents-tickets/electronic-travel-documents/pravila_oformlenija_ispol_zova.html">Правила оформления, использования и возврата электронных проездных документов на поезда с ненумерованными местами</a></li><li><a href="/ru/help/travel-documents-tickets/renewal-of-travel-documents/reordering.html">В каких случаях проездной документ (билет) можно переоформить?</a></li><li><a href="/ru/help/travel-documents-tickets/recovery-of-travel-documents/chto_delat_esli_bilet_uterjan2.html">Что делать, если проездной документ (билет) утерян или испорчен?</a></li><li><a href="/ru/help/transportation_of_baggage/pravila_perevozki_velosipedov2.html">Правила перевозки велосипедов, излишней ручной клади</a></li><li><a href="/ru/help/children_transportation/uslovija_proezda_detej.html">Перевозка детей</a></li></ul>
			</div>
			<div class="help-start__item">
